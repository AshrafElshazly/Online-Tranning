        ...
        <div class="col-md-6 my-5">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <a href="order/view.php"  class="btn btn-success">Go To Orders</a>
                </div>
        ...
        <div class="col-md-6 mx-auto my-5">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <a href="service/view.php" class="btn btn-success">Go To Services</a>
                </div>
                <div class="card-footer text-muted">
        ...
        <div class="col-8 mx-auto my-2">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <a href="order/view.php"  class="btn btn-info">Go To Orders</a>
                </div>
                <div class="card-footer text-muted">
