...
<div class="container">
    <div class="row">
<div class="col-12">
     <h1 class="text-center my-3">View All Waiting Bookings</h1>
</div>
<div class="table-responsive main-table">
        ...
        <?php 
    $bookings = bookingsdata("booking_status = 'discard'"); 
    ...
    ?> 
        <tbody>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo AURL . "bookings/accept.php?booking_id=" . $booking['booking_id'] ?>" class="btn btn-success" >Accept</a>
                    </td>
                    <td>
